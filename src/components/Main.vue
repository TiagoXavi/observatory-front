              ...
              <v-dialog
                ...
                <div class="D_Dialog">
                  ...
                  <div class="Main_DialogText">
                    <div>O Observatório das Eleições nas Redes Sociais é uma iniciativa de desenvolvimento tecnológico de pesquisadores da Universidade Federal de Goiás. Os dados são provenientes das mídias sociais de alguns candidatos durante o período eleitoral de 2022, a seleção dos candidatos para o observatório foi baseada nos 5 melhores candidatos da pesquisa ipec de 29-08-22. Um algoritmo coleta e organiza dados de seguidores, número de curtidas, compartilhamentos, número de postagens e principais hashtags e tópicos citados nos perfis dos candidatos. O "Observatório" apresenta esses dados ao longo do tempo para que os interessados acompanhem sua evolução. Não é possível garantir que os dados não tenham oscilações em função da fonte e/ou modo de coleta, o que pode implicar em observações que não sejam exatamente fidedignas com o que esteja ocorrendo nas mídias sociais dos candidatos.</div>
                  </div>
                </div>
              </v-dialog>
            </span>
